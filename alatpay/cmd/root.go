...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.alatpay/config.json)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".alatpay/config" (without extension).
		viper.AddConfigPath(home + "/.alatpay")
